...
export function PWAInstallBanner() {
  ...
  const shouldRender = isVisible && !isStandalone;
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-[calc(5.75rem+env(safe-area-inset-bottom))] place-self-start z-50 px-4 md:bottom-4 md:px-6">
