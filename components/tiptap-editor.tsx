...
export function TiptapEditor({ content, onChange }: Props) {
  ...
  return (
    <div className="rounded-xl border border-surface-300 bg-white focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:border-surface-600 dark:bg-surface-800">
      {/* Toolbar */}
